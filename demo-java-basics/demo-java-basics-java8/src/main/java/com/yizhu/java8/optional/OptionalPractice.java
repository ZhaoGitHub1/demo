package com.yizhu.java8.optional;
...
public class OptionalPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(nno2.orElse("nnew o1如果没值输出这个"));
        Optional<String> nno3 = o3.filter(v -> v.indexOf("brick") > -1);//如果字符串中存在brick
        System.out.println(nno3.orElse("nnew o1如果没值输出这个"));
        Optional<String> nno4 = o4.filter(v -> v.indexOf("brick") > -1);//如果字符串中存在brick
        System.out.println(nno4.orElse("nnew o1如果没值输出这个"));
